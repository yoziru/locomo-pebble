...
var journeyPlatformDsc = new UI.Text({
  ...
  font: 'gothic-18',
  color: 'white',
  position: new Vector2(10 + ((res.x - 20) / 2), 40),
  size: new Vector2((res.x - 20) / 2, 22),
  textAlign: 'center'
});
...
var journeyPlatform = new UI.Text({
  ...
  font: 'gothic-28-bold',
  color: 'white',
  position: new Vector2(10 + ((res.x - 20) / 2), 60),
  size: new Vector2((res.x - 20) / 2, 30),
  textAlign: 'center'
});
...
var imageArrowUp = new UI.Image({
  position: new Vector2(res.x - 24, 26),
  size: new Vector2(14, 14),
  image: 'images/arrow_up.png'
});

var imageArrowDown = new UI.Image({
  position: new Vector2(res.x - 24, 96),
  size: new Vector2(14, 14),
  image: 'images/arrow_down_blue.png'
});

var imageArrowDownRed = new UI.Image({
  position: new Vector2(res.x - 24, 96),
  size: new Vector2(14, 14),
  image: 'images/arrow_down_red.png'
});
...
var elements = {
  ...
  'imageArrowDownRed': imageArrowDownRed,
